            ...
            <div className="container">
                <div className="row justify-content-center align-items-center">
                    <div className="col-md-6">
                        <img className="img-fluid rounded border border-danger" src={"https://starwars-visualguide.com/assets/img/planets/" + params.uid + ".jpg"} alt={`${planet.name + ' Picture'}`} style={{ width: '400px', height: '400px' }} />
                    </div>
                    <div className="col-md-6">
                        <h2 className="singleCardTitle pb-2">{planet.name ? planet.name : ""} | UID # {params.uid}</h2>
